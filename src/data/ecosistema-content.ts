...
export const BODY_PARADIGM: BodyPart[] = [
  {
    ...
    color: "#4c6fae",
    eq: "son sus arterias",
    desc: "Si el flujo se interrumpe, todo lo que depende de él se resiente."
  },
  {
    label: "La información",
    color: "#ee6a5b",
    eq: "es su sistema nervioso",
    desc: "Una ciudad que no puede leer sus señales toma decisiones a ciegas."
  },
  {
    label: "Los servicios básicos",
    color: "#4a90c4",
    eq: "son su infraestructura vital",
    desc: "Agua, luz, drenaje y transporte: sin ellos, nada más funciona bien."
  },
  {
    label: "La confianza",
    color: "#8a7cc8",
    eq: "es su tejido social",
    desc: "Sin confianza, comprar, invertir, denunciar y convivir se vuelven más difíciles."
  },
  {
    label: "La economía",
    color: "#e0a23a",
    eq: "es su energía circulante",
    desc: "El ingreso, el comercio y el empleo mantienen viva la actividad cotidiana."
  },
  {
    label: "La seguridad",
    color: "#6bae6e",
    eq: "es su capacidad de habitar",
    desc: "Una ciudad insegura encoge: menos salidas, menos comercio, menos ciudad."
  }
];
...
export const METHOD_LADDER: LadderRung[] = [
  {
    ...
    method:
      "Registro situado del hecho urbano. La experiencia cotidiana se trata como un dato primario, con lugar y momento."
  },
  {
    n: 2,
    name: "Nombrar",
    ...
    method:
      "Clasificación en capas (anatomía) y ejes (síntomas). Una taxonomía común que permite comparar entre zonas y asentamientos."
  },
  {
    n: 3,
    name: "Conectar",
    ...
    method:
      "Análisis sistémico de interdependencias —cómo una capa presiona a las demás— a partir de señales repetidas y patrones por territorio."
  },
  {
    n: 4,
    name: "Comprender",
    ...
    method:
      "Inferencia de causas estructurales y formulación de hipótesis accionables, documentadas y citables en el Observatorio."
  }
];
...
export const SYMPTOMS: Symptom[] = [
  {
    see: "Una calle inundada",
    cause: "Drenaje sin mantenimiento, suelo impermeable y zonas de riesgo ocupadas durante años.",
    result: "Una ciudad más vulnerable.",
    color: "#4a90c4"
  },
  {
    see: "Tráfico constante",
    cause: "Vivienda lejos del empleo, transporte insuficiente y calles diseñadas solo para el auto.",
    result: "Una ciudad más lenta y más cara.",
    color: "#4c6fae"
  },
  {
    see: "Negocios vacíos",
    cause: "Poco flujo peatonal, baja confianza y un entorno que dejó de atraer inversión.",
    result: "Una economía local más frágil.",
    color: "#e0a23a"
  },
  {
    see: "Banquetas rotas",
    cause: "Mantenimiento sin seguimiento y al peatón colocado en último lugar.",
    result: "Una ciudad menos caminable.",
    color: "#6bae6e"
  },
  {
    see: "Inseguridad",
    cause: "Espacios abandonados, poca presencia y desconfianza que se fue acumulando.",
    result: "Una ciudad que vive a la defensiva.",
    color: "#8a7cc8"
  },
  {
    see: "Desconfianza",
    cause: "Reportes sin respuesta y promesas incumplidas, repetidas muchas veces.",
    result: "Una ciudad más difícil de cuidar.",
    color: "#ee6a5b"
  }
];
...
export const EJES: Eje[] = [
  {
    n: "01",
    name: "Ciudad interrumpida",
    desc: "Servicios básicos que fallan o se cortan. Luz, agua, transporte, comunicación.",
    color: "#4a90c4"
  },
  {
    n: "02",
    name: "Ciudad vulnerable",
    desc: "Riesgos físicos acumulados. Inundaciones, baches, infraestructura en deterioro.",
    color: "#4c6fae"
  },
  {
    n: "03",
    name: "Ciudad con miedo",
    desc: "Inseguridad que restringe movimiento, horarios, comercio y convivencia.",
    color: "#8a7cc8"
  },
  {
    n: "04",
    name: "Ciudad manipulada",
    desc: "Desinformación, rumores y narrativas que distorsionan la realidad urbana.",
    color: "#ee6a5b"
  },
  {
    n: "05",
    name: "Ciudad fragmentada",
    desc: "Desconexión entre zonas, grupos y oportunidades. Desigualdad hecha espacio.",
    color: "#e0a23a"
  },
  {
    n: "06",
    name: "Ciudad solidaria",
    desc: "Redes de apoyo, comunidad activa y acciones colectivas que sostienen el sistema.",
    color: "#6bae6e"
  },
  {
    n: "07",
    name: "Ciudad sin futuro",
    desc: "Jóvenes sin opciones, fuga de talento y ausencia de proyectos de largo plazo.",
    color: "#917a5c"
  },
  {
    n: "08",
    name: "Ciudad precaria",
    desc: "Empleo informal, renta inaccesible y economía de subsistencia como norma.",
    color: "#c47a55"
  }
];
...
export const FLUJO: FlujoStep[] = [
  {
    n: "01",
    label: "Señal",
    desc: "Una persona observa un hecho cotidiano y lo reporta: un corte de luz, una inundación, una zona insegura.",
    color: "#ee6a5b"
  },
  {
    n: "02",
    label: "Patrón",
    desc: "Otras personas reportan lo mismo. El sistema detecta zona, frecuencia y eje. La señal deja de ser aislada.",
    color: "#e0a23a"
  },
  {
    n: "03",
    label: "Impacto",
    desc: "El Observatorio conecta la señal con sus causas y consecuencias en las demás capas del ecosistema.",
    color: "#4a90c4"
  },
  {
    n: "04",
    label: "Evidencia",
    desc: "El análisis es público, citable y útil para medios, organizaciones, universidades e instituciones.",
    color: "#6bae6e"
  },
  {
    n: "05",
    label: "Acción",
    desc: "La información mejora decisiones: de ciudadanos, medios, comercios, colectivos e instituciones.",
    color: "#8a7cc8"
  }
];
...
export const KERNEL_PILLARS: KernelPillar[] = [
  {
    pillar: "Datos",
    feat: "Radar de señales",
    desc: "Cada observación ciudadana se ordena, ubica y vuelve evidencia. Reduce la ceguera operativa de la ciudad.",
    color: "#4c6fae"
  },
  {
    pillar: "Comunicación",
  ...
  {
    pillar: "Operaciones",
    feat: "De la señal a la acción",
    desc: "El flujo que convierte una experiencia individual en seguimiento, prioridad y acción coordinada.",
    color: "#6bae6e"
  },
  {
    pillar: "Inventario",
    feat: "Capas, zonas y señales",
    desc: "El mapa estructurado de la ciudad —sus capas, sus zonas, sus patrones— sobre el que todo se apoya.",
    color: "#e0a23a"
  },
  {
    pillar: "Gobernanza",
    feat: "Principios y privacidad",
    desc: "Reglas públicas, límites y supervisión humana. Sin gobernanza, la IA solo acelera el desorden.",
    color: "#8a7cc8"
  }
];
